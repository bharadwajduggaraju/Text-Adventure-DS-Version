...
def credits():
  ...
  time.sleep(17)
  #~2:33
  Output.settings("long", old)  # Currently unnecessary because of exit, left for future changes
  print() #Empty line
  sys.exit()
...
def adventureBeg():
  delay_print("""
    -action here-
    You smile. 'dialogue point', you say.
    ...
    The servant nods and smiles.
    A few minutes later, you strap your spear to your back, don your breastplate over your tunic, adjust your hair to look mildly presentable, push a bag over your shoulders, and quickly walk out of your chambers.
  """, end="", indent=4)
  time.sleep(1)
  clearConsole()
  delay_print("""
    You dash through the streets, veering wildly around the -houses which are not stone huts-, your spear clanking rhythmically on your back. Smoke floats leisurely out of the chimneys, and all around you can hear the sound of the village waking up as the sun begins to rise over the peaks of the snow-capped mountains.
  ...
  delay_print("""
    ...
    "Please, sit down. We have much to discuss." Village Regent Aviveki meets your eyes with a solmen expression.
  ...
  if sit_with_regent_aviveki == "yes" or sit_with_regent_aviveki == "y":
    delay_print("You quickly take a seat and listen.")
  ...
  time.sleep(1)
  delay_print("""  
    Aviveki meets your eyes, gaze cold. "We have reason to believe that your mother, Chieftess Amaliyah, may in fact be alive."
  ...
  option = yes_no(allow_maybe=True, errMessage="Please give the regent a clear answer- this is an important matter.")
  ...
  if (option == 'NO' or option == 'N'):
    ...
    option = yes_no(
      False, "You have one last chance to change your mind. Decide quickly.")
    if (option == 'NO' or option == 'N'):
      delay_print(
  ...
  if option == "y" or option == "yes":
    ...
    option = validate_input(["yes", "no", "y", "n"], "Decide quickly!").lower()
  ...
  """, indent=4)
  option_whee_yay_cookie_snowballcake = validate_input(["yes", "y", "no", "n"], "Will you agree with Kosu?").lower()
  ...
  """, indent=4)
  add_item("Letter for Kurigalu", "An important letter from the regent, addressed to Kurigalu of Ai'ko Le'po.")
  set_money(100)
  time.sleep(1)
  #tutorial()
  #inventorymenu()
